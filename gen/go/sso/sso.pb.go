...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of the app ti login to.
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x64, 0x69, 0x61, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
